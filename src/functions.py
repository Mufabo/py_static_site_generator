...
def text_to_textnodes(text):
    ...
    bolds = split_nodes_delimiter([text_node], "**")
    italics = split_nodes_delimiter(bolds, "_")
    codes = split_nodes_delimiter(italics, "`")
  ...
  def __copy(src, dst):
    for file in os.listdir(src):
        if os.path.isdir(file):
          __copy(os.path.join(src, file), dst)
        else:
            print(f"cp {os.path.join(src, file)} {dst}")
            os.system(f"cp -r {os.path.join(src, file)} {dst}")
  __copy(src, dst)
